export const siteConfig = {
  ...
  email: "surakshitchauhan@gmail.com",
  resumeFile: "/Surakshit.Resume.pdf",

  tagline: "Building the bridge between Cloud & Code",
  heroSubtitle:
...
When I'm not coding, you'll find me exploring new cloud services, learning about container orchestration, or contributing to open-source projects.`,
  ...
  pinnedProjects: [
    {
      name: "Resume Screening Website",
      repo: "Resume-Screening-Website-",
      url: "https://github.com/surakshit-netizen/Resume-Screening-Website-",
      description:
    ...
    },
    {
      ...
      repo: "Terraform-Code-for-App-Deployment.",
      url: "https://github.com/surakshit-netizen/Terraform-Code-for-App-Deployment.",
      description:
